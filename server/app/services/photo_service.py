...
class PhotoService:
    ...
    def get_photos(
        self, page=1, per_page=20, latitude=None, longitude=None, radius=0.01
    ):
        ...
        return {"items": photos.items, "total": total, "pages": photos.pages}
    ...
    def get_photo_stats(self):
        ...
        return {"total_photos": total_photos, "recent_photos": recent_photos}
